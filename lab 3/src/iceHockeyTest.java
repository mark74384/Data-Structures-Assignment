...
public class iceHockeyTest {
    ...
    @Test
    public void test1(){
        IPlayersFinder pf = new iceHockey();
        ...
        int team = 4;
        int threashold = 16;
        Point[] sol = pf.findPlayers(photo, team, threashold);
        assertArrayEquals(answer, sol);
    }
    @Test
    public void test2(){
        IPlayersFinder pf = new iceHockey();
    ...
    public void test3(){
        ...
        String[] photo = {"8D88888J8L8E888",
                ...
                "U88H8NI8CZB88B8",
                "8PK8H8T8888TQR8"};
        Point[] sol = new Point[] {new Point(1, 17), new Point(3, 3),
                new Point(3, 10),
                new Point(3, 25),
                new Point(5, 21),
                new Point(8, 17),
        ...
        int team = 8;
        int threashold = 9;
        Point[] result = pf.findPlayers(photo, team, threashold);
        assertArrayEquals(sol, result);
    }
    @Test
    public void test4() {
        IPlayersFinder pf = new iceHockey();
